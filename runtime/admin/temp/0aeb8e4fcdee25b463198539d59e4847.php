<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:51:"E:\workspace\B2C\template\admin\rbac\role\list.html";i:1554195608;s:43:"E:\workspace\B2C\template\admin\layout.html";i:1554195608;}*/ ?>
<!DOCTYPE html>
<html>
	<head>
		<meta charset="utf-8">
			...
			<form class="layui-form top-search-form" action="" onsubmit="return false;">
		        <div class="layui-form-pane">
					...
					<div class="layui-btn-group layui-layout-right">
						...
						<button class="layui-btn layui-btn-sm layui-bg-red" id="batch-delete" data-url="<?php echo url($ctrl.'/'.$action.'_del'); ?>" data-title="角色">
        ...
        dealParam: {
        	...
        	edit: {
                ...
                callback: function(row) {
                    tools.adminShow('编辑角色',"<?php echo url($ctrl.'/'.$action.'_edit'); ?>?id=" + row.id);
                }
            },
            <?php endif; if($rbac->check($ctrl.'/'.$action.'_del')): ?>
            del:{
                ...
                icon: "fa fa-trash-o",
                callback: function(row) {
                	tools.delItem("<?php echo url($ctrl.'/'.$action.'_del'); ?>",[row.id],'角色');
                }
            }
           	<?php endif; ?>
        },
