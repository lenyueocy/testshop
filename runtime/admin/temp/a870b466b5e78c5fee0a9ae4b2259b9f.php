<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:53:"E:\workspace\B2C\template\admin\order\order\list.html";i:1554195608;s:43:"E:\workspace\B2C\template\admin\layout.html";i:1554195608;}*/ ?>
<!DOCTYPE html>
<html>
	<head>
		<meta charset="utf-8">
			...
			<form class="layui-form top-search-form" action="" onsubmit="return false;">
		        <div class="layui-form-pane">
		        	<div class="layui-form-item">
						...
						<?php if($admin['groupid'] == 0): ?>
		                <div class="layui-input-inline">
		                    <select class="layui-input" name="fromid">
		                    	<option value="">请选择团长</option>
		                    	<?php if(is_array($groups) || $groups instanceof \think\Collection || $groups instanceof \think\Paginator): $i = 0; $__LIST__ = $groups;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$g): $mod = ($i % 2 );++$i;?>
		                    		<option value="<?php echo $g['id']; ?>"><?php echo $g['realname']; ?></option>
		                    	<?php endforeach; endif; else: echo "" ;endif; ?>
		                    </select>
		                </div>
						<?php else: ?>
						<input type="hidden" name="fromid" value="<?php echo $admin['groupid']; ?>">
						<?php endif; ?>
		                <div class="layui-input-inline">
...
window.recall=function(){
    ...
    <?php if($admin['groupid'] > 0): ?>
        getWhere:function(){
            var wh = {};
                wh['a.fromid'] = "<?php echo $admin['groupid']; ?>";
    ...
    <?php endif; ?>
        ...
        colModel: [{
            ...
            name: 'groupername',
            dealItem:function(row){
            	return '<div>'+row.groupername+'<br/>'+row.groupermobile+'</div>';
            }
        },{
            display: '地址',
            name: 'address',
            dealItem:function(row){
                return '<div  style="width:200px;">'+row.grouparea+'<br>'+row.address+'</div>';
            }
        }, {
            display: '支付金额',
            name: 'orderfee',
