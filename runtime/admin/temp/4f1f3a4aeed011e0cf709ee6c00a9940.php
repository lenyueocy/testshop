<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:55:"E:\workspace\B2C\template\admin\order\order\detail.html";i:1554195608;s:43:"E:\workspace\B2C\template\admin\layout.html";i:1554195608;}*/ ?>
<!DOCTYPE html>
<html>
	<head>
		<meta charset="utf-8">
				...
				<div class="layui-tab">
					...
					<div class="layui-tab-content">
						<div class="layui-tab-item layui-show">
			                ...
			                <div class="d-item-col">
			                	<div class="d-item">
			                        <div class="d-title">团长姓名</div>
			                        <div class="d-content"><?php echo $detail['groupername']; ?></div>
			                    </div>
			                    <div class="d-item">
			                        <div class="d-title">团长手机号</div>
			                        <div class="d-content"><?php echo $detail['groupermobile']; ?></div>
			                    </div>
			                </div>
							<div class="d-item-col">
			                    <div class="d-item d-block">
			                        <div class="d-title">地址</div>
			                        <div class="d-content"><?php echo $detail['grouparea']; ?><br><?php echo $detail['address']; ?></div>
			                    </div>
			                </div>
			            </div>
			            <!-- 红包信息 -->
