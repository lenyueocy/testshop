<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:51:"E:\workspace\B2C\template\admin\rbac\node\list.html";i:1554195608;s:43:"E:\workspace\B2C\template\admin\layout.html";i:1554195608;}*/ ?>
<!DOCTYPE html>
<html>
	<head>
		<meta charset="utf-8">
		        ...
		        <div class="layui-form-pane">
					...
					<div class="layui-btn-group layui-layout-right">
						...
						<button class="layui-btn layui-btn-sm" id="sort-btn">
							<i class="fa fa-file-text"></i>更新排序
						</button>
						<?php endif; ?>
					</div>
		        </div>
...
window.recall=function(){
    ...
    $(".table_box").on('click', '.del-menu', function() {
    	...
    	layer.confirm('确定要删除该节点及其所有子节点吗？',function(){
    		layer.closeAll();
